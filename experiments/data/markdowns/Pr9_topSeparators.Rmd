...
```
This looks rather complicated and I won't continue here, as choosing clusters
would be arbitrary.  
...
This is a 3-cell CTC-cluster, so I am expecting up to 3 distinct genotype
clusters.
...
mat <- mat3
d_mat <- as.dist(mat)
hc <- hclust(d_mat, "average") ## hierarchical clustering of mutations based
# on distance matrix
par(cex = 0.6)
plot(
  hc,
...
This dataset is complicated and clusterings are highly unstable/depend strongly
on the filter.
