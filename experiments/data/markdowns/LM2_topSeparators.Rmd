...
Two genetic clusters could be identified in the 3-cell CTC cluster, but only with moderate functional impact variants.
...
###Overview
Plotting the full distance matrix exceeds the C stack,so I do some soft filtering of 
mutations:
