data <- data.frame(
  sample = c(
    "Br11", "Br11", "Br11", "Br23", "Br23", "Br23", "Br38", "Br38", "Br38", "Br39", "Br39", "Br39", "Br61", "Br61", "Br61", "Brx50", "Brx50", "Brx50", "LM2", "LM2", "LM2", "Lu2", "Lu2", "Lu2",
...
data %>%
  group_by(Category) %>%
  dplyr::summarize(TotalCounts = sum(Counts)) %>%
