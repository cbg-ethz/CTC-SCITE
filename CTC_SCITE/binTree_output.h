...
//std::string getGraphVizBinTree(int* parents, int m, vector<string>& label, double score);
...
//string getGraphVizBinTree(int* parents, int m, vector<string>& label, double score, double dropoutRate, double seqErrorRate, vector<int>& clusterId, vector<int>& bestPlacementPoint);
